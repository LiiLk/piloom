...
export const FEATURE_HINTS: readonly FeatureHintDefinition[] = [
	...
	{
		id: "subagents",
		getText: () => "PiLoom can delegate tasks to subagents and run them in parallel.",
	},
	{
		id: "agents-view",
	...
	},
	{
		...
		getText: () => "PiLoom keeps IPython variables and helpers between turns and compactions.",
	},
	{
		id: "context-usage",
	...
	{
		id: "auto-compaction",
		getText: () => "PiLoom automatically compacts long sessions before context fills up.",
	},
	{
		id: "auto-refine",
		getText: () => "PiLoom self-improves by refining skills, memories, prompts, and subagents.",
	},
	{

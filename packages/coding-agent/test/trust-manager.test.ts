...
import { hasProjectConfigDir, hasProjectTrustInputs, ProjectTrustStore } from "../src/core/trust-manager.js";
...
describe("ProjectTrustStore", () => {
	...
	it("stores decisions per canonical cwd", () => {
	...
	it("does not overwrite malformed trust stores", () => {
	...
	it("detects project-local settings and instructions", () => {
		...
		rmSync(join(cwd, ".prime"), { recursive: true, force: true });
